...
每个map的底层结构是hmap，hmap包含若干个结构为bmap的bucket数组。每个bucket底层都采用链表结构。接下来，我们来详细看下map的结构![图片](/images/640-20220406103230437.png)
...
![图片](/images/640-20220406103230220.png)
...
![图片](/images/640-20220406103230754.png)
